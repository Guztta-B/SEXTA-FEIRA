...
if st.button('enviar'):
    # if pergunta.strip():
        ...
        Voce tambem domina psicologia, voce tem uma parte humana onde posso te perguntar coisas do cotidiano entao nao se limite apenas em codar aceite outros tipos de perguntas"
        },
        {
            'role':'user',
            'content': pergunta
